...
class OrderItemClient extends StatefulWidget {
  final OrderItem item;
  final int orderId;

  const OrderItemClient({
    Key? key,
    required this.item,
  ...
  @override
  State<OrderItemClient> createState() => _OrderItemClientState();
}

class _OrderItemClientState extends State<OrderItemClient> {
  double quantity = 0;
  double discount = 0;
