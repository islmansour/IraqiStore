...
import 'package:hardwarestore/components/client/client_account_forms.dart';
...
class SignLegalDocuments extends StatefulWidget {
  final Account account;
  SignLegalDocuments({Key? key, required this.account}) : super(key: key);

  @override
  State<SignLegalDocuments> createState() => _SignLegalDocumentsState();
}

class _SignLegalDocumentsState extends State<SignLegalDocuments> {
  ...
  Widget build(BuildContext context) {
    ...
    return ClientAccountLegalFormsList(account: widget.account);
    // return Form(
    //   key: _formKey,
    //   child: Container(
